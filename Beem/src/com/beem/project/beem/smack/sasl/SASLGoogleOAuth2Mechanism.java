...
/**
 * An implementation of the SASL OAuth2 mechanism made by Google. The extension
 * is described here : https://developers.google.com/talk/jep_extensions/oauth
 */
public class SASLGoogleOAuth2Mechanism extends SASLMechanism {
	...
	protected void authenticate() throws IOException, XMPPException {
		...
		getSASLAuthentication().send(
				new GoogleOAuthMechanism(authenticationText));
	}
