...
public class AvatarProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI = Uri
			.parse("content://com.beem.project.beem.providers.avatarprovider");
	...
	static {
		...
		// should not be needed if we pass AVATAR on the constructor but it does
		// not work
	...
	public boolean onCreate() {
		...
		File dataPath = new File(cacheDir,
				"/Android/data/com.beem.project.beem/cache/avatar");
		dataPath.mkdirs();
