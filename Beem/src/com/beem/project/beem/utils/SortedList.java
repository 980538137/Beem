...
/**
 * This class add a sort by insertion to a List. All methods which allow you to
 * insert an object at a specific index will throw an
...
public class SortedList<E> implements List<E> {
	...
	/**
	 * Add all the elements in the specified collection. The index param is
	 * ignored.
	 * 
	 * @param index
	 *            ignored
	...
	/**
	 * A SortedList.iterator don't allow list modification. It use the mBackend
	 * iterator for the other operations.
	 */
	private class SortedListIterator<E> implements ListIterator<E> {
		 ...
		 * 
		 * @param iterator
		 *            the iterator of the backend list
		 */
